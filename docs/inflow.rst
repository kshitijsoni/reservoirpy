...
.. list-table:: Inflow Functions
   ...
   * - Gas Flow Rate Radial
     - `reservoirpy.gas_rate_radial`_  
   * - Gas Flow Rate Linear 
     - `reservoirpy.gas_rate_linear`_
   * - Oil Flow Rate Radial
     - `reservoirpy.oil_rate_radial`_
   * - Oil Flow Rate Linear
     - `reservoirpy.oil_rate_linear`_
  

reservoirpy.gas_rate_radial
======================
