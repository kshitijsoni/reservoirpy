...
.. list-table:: Gas Functions
   ...
   * - Gas Tc & Pc Calculation
     - `reservoirpy.gas_tc_pc`_  
   * - Gas Z-Factor Calculation
     - `reservoirpy.gas_z`_
   * - Gas Viscosity
     - `reservoirpy.gas_ug`_
   * - Gas Viscosity * Z
     - `reservoirpy.gas_ugz`_
   * - Gas Compressibility
     - `reservoirpy.gas_cg`_
   * - Gas Formation Volume Factor
     - `reservoirpy.gas_bg`_  
   * - Gas Density
     - `reservoirpy.gas_den`_  
   * - Gas Water of Condensation
     - `reservoirpy.gas_water_content`_
   * - Convert P/Z to P
     - `reservoirpy.gas_ponz2p`_
   * - Convert Gas Gradient to SG
     - `reservoirpy.gas_grad2sg`_
   * - Delta Pseudopressure
     - `reservoirpy.gas_dmp`_
   * - Gas Condensate FWS SG
     - `reservoirpy.gas_fws_sg`_
  

reservoirpy.gas_tc_pc
======================
