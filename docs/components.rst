...
.. list-table:: Component Library Functions
   ...
   * - Return Critical Property 
     - `reservoirpy.comp_library.prop`_  
   * - List of all components in Library
     - `reservoirpy.comp_library.components`_
   * - List of all long-form names of components in Library
     - `reservoirpy.comp_library.names`_
   * - Returns a list of all critical properties available for components in the Library
     - `reservoirpy.comp_library.property_list`_
   * - Returns a list of all valid EOS models in the Library 
     - `reservoirpy.comp_library.models`_
   * - Returns a DataFrame of the Library 
     - `reservoirpy.comp_library.df`_
     
     

reservoirpy.comp_library.prop
======================

.. code-block:: python

    reservoirpy.comp_library.prop(comp, prop, model = 'PR79') -> float:
...
reservoirpy.comp_library.components
======================

.. code-block:: python

    reservoirpy.comp_library.components -> list:
...
reservoirpy.comp_library.names
======================

.. code-block:: python

    reservoirpy.comp_library.names -> list:
...
reservoirpy.comp_library.property_list
======================

.. code-block:: python

    reservoirpy.comp_library.property_list -> list:
...
reservoirpy.comp_library.models
======================

.. code-block:: python

    reservoirpy.comp_library.models -> list:
...
reservoirpy.comp_library.df
======================

.. code-block:: python

    reservoirpy.comp_library.df -> pandas.DataFrame:
