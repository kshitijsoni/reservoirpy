...
""reservoirpy - A collection of Reservoir Engineering Utilities
              Copyright (C) 2023, Kshitij Soni
    ...
    and at  <https://www.gnu.org/licenses/>.
          ...
          Contact author at kshitijsoni@iipe.ac.in
"""""
...
def influence_tables(
    ...
    if export:
        ...
        inc_out += "-- transform by reservoirpy\n"
        inc_out += "---------------------------------------\n"
        inc_out += "--\n"
